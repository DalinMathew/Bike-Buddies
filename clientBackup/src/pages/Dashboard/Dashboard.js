            ...
            <div key={index} className="booking-card">
              ...
              <div className="details">
                <div className="detail-section">
                  <h3>Bike Details</h3>
                  <p>
                    <strong>Name:</strong> {booking.bike.name}
                  </p>
                  <p>
                    <strong>Type:</strong> {booking.bike.type}
                  </p>
                  <p>
                    <strong>Price:</strong> {booking.bike.price}
                  </p>
                  <img
                    src={`http://localhost:9000/media/${booking.bike.image}`}
                ...
                <div className="detail-section">
                  ...
                  <p>
                    <strong>Age:</strong> {booking.customer.age}
                  </p>
                  <p>
                    <strong>Email:</strong> {booking.customer.email}
                  </p>
                  <p>
                    <strong>Mobile:</strong> {booking.customer.mobile}
                  </p>
                </div>
                <div className="detail-section">
                  <h3>Rider Details</h3>
                  ...
                  <p>
                    <strong>Age:</strong> {booking.rider.age}
                  </p>
                  <p>
                    <strong>Email:</strong> {booking.rider.email}
                  </p>
                  <p>
                    <strong>Mobile:</strong> {booking.rider.mobile}
                  </p>
                </div>
                <div className="detail-section">
                  <h3>Trip Details</h3>
                  ...
                  <p>
                    <strong>Trip Date:</strong> {booking.tripDatel}
                  </p>
                  <p>
