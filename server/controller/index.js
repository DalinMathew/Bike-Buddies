...
app.use("/api/discussion", require("./routes/Other Api/discussion.route"))
app.use("/api/chat", require("./routes/Other Api/chat.route"));
app.use("/api/group", require("./routes/Other Api/group.route"));
app.use("/api/exam", require("./routes/Other Api/exam.route"));
app.listen(port, () => {
